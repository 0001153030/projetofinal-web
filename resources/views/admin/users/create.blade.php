...
@section('content')
    <div class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-sky-100 dark:border-gray-800 max-w-lg mx-auto">
        <h1 class="text-lg font-semibold text-sky-600 dark:text-sky-400 mb-4">Nova conta</h1>
        ...
        <form method="POST" action="{{ route('admin.users.store') }}">
            ...
            <input name="name" value="{{ old('name') }}" class="w-full mb-3 p-2 border border-sky-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800" />
            ...
            <input name="email" value="{{ old('email') }}" class="w-full mb-3 p-2 border border-sky-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800" />
            ...
            <div class="text-right">
                ...
                <button class="px-3 py-2 bg-sky-600 text-white rounded-lg hover:bg-sky-700">Criar conta</button>
            </div>
        </form>
    </div>
@endsection
